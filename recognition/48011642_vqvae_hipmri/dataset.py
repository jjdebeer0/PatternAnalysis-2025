...
def load_latent_block(batch_size, file, transform, data_path):
    """Load HipMRI images and return data loader
    ...
    Example:
        ...
        > data, loader, var = dataset.load_data(32, '/latent_e_indices_train.npy', transform,
        '/home/groups/comp3710/HipMRI_Study_open/keras_slices_data')
    """

    data = LatentBlockDataset(data_path + file, transform=None)
